		...
		SwitchStmt* SwitchStmt::TryCreate(TokenContainer* pTokenContainer, OffsetDatum* pOffsetDatum)
		{
			...
			while (true)
			{
				...
				if (pDefaultToken != 0)
				{
					...
					{
						NumberDuck::Secret::AST* __4278855511 = pDefaultStatement;
						pDefaultStatement = 0;
					...
					{
						NumberDuck::Secret::AST* __1253506085 = pScopedDefaultStatement;
				...
				{
					NumberDuck::Secret::AST* __3025039859 = pCaseExpression;
					pCaseExpression = 0;
				...
				{
					NumberDuck::Secret::AST* __3618575045 = pCaseStatement;
					pCaseStatement = 0;
				...
				{
					NumberDuck::Secret::AST* __128648087 = pScopedCaseStatement;
			...
			{
				NumberDuck::Secret::SwitchStmt* __3496390470 = pSwitchStmt;
				pSwitchStmt = 0;
				{
					if (pTempOffset) delete pTempOffset;
					if (pExpression) delete pExpression;
