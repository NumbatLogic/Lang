...
namespace NumberDuck
{
	namespace Secret
	{
		...
		TrinaryExpr* TrinaryExpr::Create(AST* pFirstExpressionTransition, TokenContainer* pTokenContainer, OffsetDatum* pOffsetDatum)
		{
			...
			{
				NumberDuck::Secret::AST* __1176577974 = pFirstExpression;
				pFirstExpression = 0;
				pTrinaryExpr->AddChild(__1176577974);
			}
			{
				NumberDuck::Secret::AST* __2317218345 = pSecondExpression;
				pSecondExpression = 0;
				pTrinaryExpr->AddChild(__2317218345);
			}
			{
				NumberDuck::Secret::AST* __2588391620 = pThirdExpression;
				pThirdExpression = 0;
				pTrinaryExpr->AddChild(__2588391620);
			}
			pOffsetDatum->Set(pTempOffset);
			{
				NumberDuck::Secret::TrinaryExpr* __1659060397 = pTrinaryExpr;
				pTrinaryExpr = 0;
				{
					if (pTempOffset) delete pTempOffset;
					if (pFirstExpression) delete pFirstExpression;
