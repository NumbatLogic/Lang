...
#line 24 "/home/cliffya/git/Lang/Source/Core/AST/TypeRef.nll"
	TypeRef::TypeRef()
	{
		...
		m_pCloneToken = 0;
		m_pFoundType = 0;
#line 26 "/home/cliffya/git/Lang/Source/Core/AST/TypeRef.nll"
...
#line 122 "/home/cliffya/git/Lang/Source/Core/AST/TypeRef.nll"
					pTempOffset->m_nOffset = pTempOffset->m_nOffset + 1;
					if (pGenericTypeRef) delete pGenericTypeRef;
				}
			}
...
#line 138 "/home/cliffya/git/Lang/Source/Core/AST/TypeRef.nll"
				return 0;
			}
...
#line 302 "/home/cliffya/git/Lang/Source/Core/AST/TypeRef.nll"
			if (pType == 0)
			{
				...
				{
#line 312 "/home/cliffya/git/Lang/Source/Core/AST/TypeRef.nll"
...
#line 327 "/home/cliffya/git/Lang/Source/Core/AST/TypeRef.nll"
				return;
			}
...
#line 345 "/home/cliffya/git/Lang/Source/Core/AST/TypeRef.nll"
					if (m_pChildTypeRef == 0)
					{
						...
						if (pCandidates) delete pCandidates;
						if (pTypeLike) delete pTypeLike;
#line 348 "/home/cliffya/git/Lang/Source/Core/AST/TypeRef.nll"
						return;
					}
#line 351 "/home/cliffya/git/Lang/Source/Core/AST/TypeRef.nll"
					if (m_pChildTypeRef->m_pTypeToken->m_eType != Token::Type::TOKEN_IDENTIFIER)
					{
						...
						if (pCandidates) delete pCandidates;
						if (pTypeLike) delete pTypeLike;
#line 354 "/home/cliffya/git/Lang/Source/Core/AST/TypeRef.nll"
						return;
					}
